  ...
  - 💻 **Tech Stack:** Java (Spring Boot), Apache Kafka, Python, TypeScript, React, Node.js, AWS, Docker, PostgreSQL, Redis, Elasticsearch, Git
  - 🧠 **Currently Learning:** Kubernetes, advanced system design, and cloud-native architecture
  ...
  **Stack:** JavaScript • Next.js • TailwindCSS • Vercel
  ...
  ### 🗓️  Recent Activity
  - 🔭 Working on **JobConnect** (React + Java Spring Boot)
  - 📚 Studying **System Design and Cloud Architecture**
  - 💬 Open for collaboration on backend or full-stack Java projects
  - 🌍 Actively seeking **Backend / Full-Stack Java Engineer** roles in Canada
